---
name: review-this
description: Produce a structured review of code or documentation with category ratings, an overall score, a checklist, and actionable improvement suggestions. Use when the user asks for a review, feedback, or critique.
license: Apache-2.0
metadata:
  source: .prompts/review-this.md
  version: "1.0"
---
